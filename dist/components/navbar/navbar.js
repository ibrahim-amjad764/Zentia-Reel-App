...
export function Navbar() {
    ...
    return (<div className="sticky top-0 z-50 border-b bg-white dark:bg-gray-900">
      <div className="mx-auto max-w-5xl flex items-center gap-4 px-4 py-2">
        <Link href="/" className="font-bold text-lg">
          MySocial
        </Link>
        ...
        <div className="flex-1 flex justify-center">
          <div className="relative w-full max-w-sm">
            ...
            <input type="text" placeholder="Search posts..." value={query} onChange={(e) => setQuery(e.target.value)} onKeyDown={handleKeyPress} className="w-full pr-10 pl-4 py-2 rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
          </div>
        </div>
      ...
      <CreatePostModal open={openPost} onClose={() => setOpenPost(false)} // Close modal when onClose is triggered
    />
    </div>);
}
