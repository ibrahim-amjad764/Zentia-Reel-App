const LogoSvg = (props) => {
    return (<svg width="1em" height="1em" viewBox="0 0 328 329" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <path d="M166.627 265.241V204.771C166.627 184.889 182.744 168.771 202.627 168.771H261.416" stroke="white" strokeWidth="20" className="dark:stroke-black"/>
