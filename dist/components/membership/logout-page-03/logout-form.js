...
const LogoutButton = forwardRef(({ onDone, className }, ref) => {
    ...
    return (<Button ref={ref} variant="destructive" className={`${className} w-full justify-start`} // Merge custom className with the default class
     onClick={handleLogout} disabled={loading} // Disable button while loading
    >
